...
const useFluidAnimation = (sensitivityConfig) => {
    ...
    const setupAnimation = (containerRef, sphere1Ref, sphere2Ref) => {
        let animationFrameId;
        const mousePos = { x: 0, y: 0 };
        const sphere1Pos = { x: -200, y: 200, vx: 0, vy: 0 };
        const sphere2Pos = { x: 200, y: -200, vx: 0, vy: 0 };
        let time = 0;
...
export default useFluidAnimation;